...
#Get all the numbers into a Python list
for nrow in snum.split("\n"):
    row = []
...
def findvlines(numbers):
    """
    Find all the vertical lines of 4 numbers
    """
    #Line length
    ll = 4
    ...
    for yshift in range(len(numbers)-(ll-1)):
        #Shift in the row
        for xshift in range(len(numbers[yshift])):
            #The current line
            line = []
            #Shift downwards to the length of the line
...
def findhlines(numbers):
    ...
    for yshift in range(len(numbers)):
        ...
        for xshift in range(len(numbers[yshift])-(ll-1)):
            #The current line
            line = []
            #Shift over to the length of the line
            for lineshift in range(ll):
...
biggest = []
print("v:")
v = getbiggest(numbers, findvlines)
print("h:")
h = getbiggest(numbers, findhlines)
print("dd:")
dd = getbiggest(numbers, findddlines)
print("du:")
du = getbiggest(numbers, finddulines)
